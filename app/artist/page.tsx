...
import MoreArtist from "@/components/MoreArtist";
  ...
  return (
    <section className="overflow-hidden">
      ...
      <div className="px-4 md:px-32 py-4 ">
        <div className="flex flex-col md:flex-row  justify-between drop-shadow-xl">
          <div className="flex-1 space-y-3">
            ...
            >
              ...
              Orbitians. They live in metal space machines, high up in the sky
              ...
              territory, so theyve taken to make human beings their target.
            </motion.h1>
            <motion.h1
              className="font-sans text-gray-500 text-lg font-semibold"
              initial={{ y: -20, opacity: 0 }}
